...
module.exports = function(config) {
  ...
  function getVenue(venueId, accessToken, callback) {
    ...
    logger.debug('getVenue:path: ' + path);

    core.callApi(path, accessToken, null, callback);
  }
  ...
  function getVenueAspect(venueId, aspect, params, accessToken, callback) {
    ...
    logger.debug('getVenueAspect:path: ' + path);
    core.callApi(path, accessToken, params || {}, callback);
  }
